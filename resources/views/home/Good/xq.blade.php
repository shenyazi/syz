					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/homes/images/01.jpg"><img src="{{$goods->gpic}}" alt="细节展示放大镜特效" rel="{{$goods->gpic}}" class="jqzoom" /></a>
							</div>
								...
								<dd>
									...
									<div class="theme-popover">
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="/home/xq" method="post">
