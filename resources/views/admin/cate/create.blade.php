                        ...
                        <div class="panel-body">
                            <form role="form" action="{{url('admin/cate')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" style="width:400px;" class="form-control" name="cate_name" value="{{old('cate_name')}}" placeholder="填写分类">
                                </div>
                                <div class="form-group" style="margin-bottom: 30px;">
                                    <label for="exampleInputPassword1" style="margin-bottom: 15px;">排序</label>
                                    <input type="text" style="width:400px;" class="form-control" name="cate_order" value="{{old('cate_order')}}" placeholder="填写排序">
                                </div>
