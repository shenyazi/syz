              ...
              <div class="row">
                  ...
                  <div class="col-lg-12">
                      ...
                      <section class="panel">
                          ...
                          <form action="{{url('role')}}" method='get' style='padding:12px;margin-left:55px'>
                              <b >每页显示条数:</b>
                                <select name='num'>
                              ...
                              <b style='margin-left:50px'>角色名:</b><input type="text" name="name" value="{{$request->name}}">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th class="hidden-phone"><i class="icon-question-sign"></i>角色名称</th>
                                  <th><i class="icon-bookmark"></i>角色描述</th>
                                  <th>操作</th>
                              </tr>
                              </thead>
                              <tbody>
                            @foreach($roles as $v)
                              <tr>
                                  ...
                                  <td>{{$v->desc}} </td>
                                  <td>
                                      <a href="{{url('role/auth/'.$v->id)}}" style='margin-right:3px;float:left'>授权</a>
                                      <a href="{{url('role/'.$v->id.'/edit')}}" style='margin-right:3px;margin-left:5px;float:left'><button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button></a>
